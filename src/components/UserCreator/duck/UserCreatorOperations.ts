...
const isSomeValueInObjectEmpty = (obj: Object): Boolean =>
  Object.keys(obj).some(isValueOfKeyEmptyInObject(obj));

const passwordsMatch = (password: String, repeatedPassword: String) =>
...
export const validateNewUserData = (
  ...
  const objToCheck = Object.assign(
    basicFields,
    isPasswordMandatory ? { newPassword, newPasswordRepeat } : {}
  );
